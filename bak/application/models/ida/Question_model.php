...
class Question_model extends CI_Model{
    ...
    */ 
    public function getQuestionType(){
        ...
        $type = array();
        $type_cursor = self::$_db->cloud_teaching->command(array('distinct' => 'question', 'key' => 'question_type'));
    ...
    */ 
    public function addQuestion($question){
        ...
        self::$_db->cloud_teaching->question->insert($question, array('safe' => TRUE));
        if ($question['_id']){
    ...
    */ 
    public function dumpQuestion($question_type, $type){
        ...
        $cursor = self::$_db->cloud_teaching->question->find(array('type' => $type, 'question_type' => $question_type), array('question_id' => 1));
