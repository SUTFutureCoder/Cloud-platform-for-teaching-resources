...
class ErrorCodes {
    ...
    const ERROR_BOS_SERVER_CALLBACK_MISSING = 20002;
    const ERROR_BOS_UPLOAD_ERROR            = 20003;
    ...
    public static $error_codes = array(
        ...
        self::ERROR_BOS_SERVER_CALLBACK_MISSING => 'upload to bos server error, null callback, please check error of bos server',
        self::ERROR_BOS_UPLOAD_ERROR            => 'upload to bos server return error',
    );
