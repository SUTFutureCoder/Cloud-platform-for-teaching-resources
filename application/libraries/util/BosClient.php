...
class BosClient {
     ...
     * @throws MException
     */
    public static function putObjectFromFile($bucketId, $key, $filePath, $fileReName = null, $isPublic = 1, $options = array()){
        if (!is_file($filePath)){
            throw new MException(CoreConst::MODULE_BOS, ErrorCodes::ERROR_BOS_FILE_NOT_EXIST);
        }

        //百度库首先获取mime
        $options[BosOptions::CONTENT_TYPE] = self::getMimeType($filePath);
